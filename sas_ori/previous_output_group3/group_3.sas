...
proc sgplot data=size_&var ;
  ...
  yaxis label= "Texts"  ranges=(min-110000 110000-max);
...
proc sgplot data=size_&var ;
  ...
  yaxis label= "Words" ranges=(min-1250000 1250000-max) ;
  xaxis label= "Year" labelattrs=(size=10);
run;
%mend repeat_do;
%repeat_do(var=year)
